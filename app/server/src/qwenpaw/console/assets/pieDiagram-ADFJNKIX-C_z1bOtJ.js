import{az as U,ay as Z,aA as V,aB as j,aU as q,aT as H,aC as s,aF as w,aD as J,b3 as K,bs as Q,bu as X,bv as G,bw as Y,aG as ee,aZ as te,bx as ae,b4 as re}from"./ui-vendor-BNrvn_-G.js";import{p as ie}from"./chunk-4BX2VUAB-DJzLQAXJ.js";import{p as se}from"./treemap-GDKQZRPO-LU29rfgz.js";import"./react-vendor-DbJ-LMl-.js";import"./utils-vendor-CDjmzrpq.js";import"./markdown-vendor-DJqwQoxm.js";var le=re.pie,D={sections:new Map,showData:!1},g=D.sections,C=D.showData,oe=structuredClone(le),ne=s(()=>structuredClone(oe),"getConfig"),ce=s(()=>{g=new Map,C=D.showData,te()},"clear"),pe=s(({label:e,value:a})=>{if(a<0)throw new Error(`"${e}" has invalid value: ${a}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);g.has(e)||(g.set(e,a),w.debug(`added new section: ${e}, with value: ${a}`))},"addSection"),de=s(()=>g,"getSections"),ge=s(e=>{C=e},"setShowData"),ue=s(()=>C,"getShowData"),W={getConfig:ne,clear:ce,setDiagramTitle:H,getDiagramTitle:q,setAccTitle:j,getAccTitle:V,setAccDescription:Z,getAccDescription:U,addSection:pe,getSections:de,setShowData:ge,getShowData:ue},fe=s((e,a)=>{ie(e,a),a.setShowData(e.showData),e.sections.map(a.addSection)},"populateDb"),he={parse:s(async e=>{const a=await se("pie",e);w.debug(a),fe(a,W)},"parse")},me=s(e=>`
  .pieCircle{
